...
const string strMessageMagic = "Flexiblecoin Signed Message:\n";
...
{
    int64_t nSubsidy = pindexBest->nHeight * COIN;
	
	if(pindexBest->nHeight == 2)
	{
		int64_t nSubsidy = 1300000 * COIN;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Flexiblecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "May 1409020655 Finance Gods be with you";
        CTransaction txNew;
        txNew.nTime = 1409020655;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xa60d13ed109c7812281bcb1caf27052d212351431e48590e9e59fe2dc6601b4f"));
        block.print();
