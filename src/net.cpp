...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("Flexiblecoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("Flexiblecoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Flexiblecoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    ...
    {"206.54.176.252", "206.54.176.252"},
    {"185.49.144.66", "185.49.144.66"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("Flexiblecoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("Flexiblecoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("Flexiblecoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("Flexiblecoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Flexiblecoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("Flexiblecoin-start");
