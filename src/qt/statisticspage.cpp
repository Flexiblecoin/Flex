...
void StatisticsPage::updateStatistics()
{
    ...
    double nSubsidy = pindexBest->nHeight - 1;
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " FLEX" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " FLEX" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " FLEX");
    }
